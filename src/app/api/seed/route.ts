...
export async function POST() {
  try {
    ...
    { name: "Don Khumalo", role: "HOD", department: "SHERQ", email: "Donk@sas.co.za", sortOrder: 0, isAdmin: true },
    { name: "Peter S. Mavundla", role: "Presenter", department: "SHERQ", email: "PeterSM@sas.co.za", sortOrder: 1, isAdmin: true },
