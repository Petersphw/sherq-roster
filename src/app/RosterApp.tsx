...
export default function RosterApp({
  ...
  useEffect(() => { if (seeded) { fetchRoster(mo, yr); fetchStats(); fetchWeather(); fetchSettings(); if (currentUserId) fetchInbox(); } }, [mo, yr, tab, seeded, fetchRoster, fetchStats, currentUserId]);
